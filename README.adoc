...
image:https://img.shields.io/badge/license-GPL-3.0-green[License,link="https://www.gnu.org/licenses/gpl-3.0.html"]
image:https://img.shields.io/badge/rolemaster-rmu[Rolemaster,link="http://ironcrown.co.uk/unified-rolemaster/"]
