...
[options,header]
|===
|Module                   | Repository                                            | Language
|API Core                 | https://github.com/labcabrera/rmu-api-core            | Node JS
|API Strategic            | https://github.com/labcabrera/rmu-api-strategic       | Node JS
|API Tactical             | https://github.com/labcabrera/rmu-api-tactical        | Node TS
...
|API NPC Names            | https://github.com/labcabrera/rmu-api-npc-names       | Node TS
