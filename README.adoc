...
|MFE Shell                | https://github.com/labcabrera/rmu-fe-host             | React
|MFE Core                 | https://github.com/labcabrera/rmu-fe-core             | React
|MFE Strategic            | https://github.com/labcabrera/rmu-fe-strategic        | React
|MFE Tactical             | https://github.com/labcabrera/rmu-fe-tactical         | React
|MFE NPC                  | https://github.com/labcabrera/rmu-fe-npc              | React
|===
